...
'''
import sys
sys.path.append('/home/pkq403/TFG/non_linear_fsr_compressor/coder/minimal_fsr')
...
'''
TODO(Cuando ya este hecho para 2 bytes): adaptar el segmento len de cada minterm al numero de bis minimo para representar la m como maximo, 
por ejemplo para 350 necesitaras 9 bits, asi que eso sera lo que ocupe el segmento len
'''
# Por ahora solo se pueden comprimir data que en binario ocupe menos de 8kibibyes = 8192
...
def code_to_nlfsr_format(path_inputfile, path_outputfile):
    ...
    print(f"[!] Coding Complete - {path_inputfile}")
    return nlc
